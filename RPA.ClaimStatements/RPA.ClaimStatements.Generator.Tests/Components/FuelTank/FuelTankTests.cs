...
namespace RPA.ClaimStatements.Generator.Tests.Components.FuelTank
{
    [TestFixture]
    [Category("Fuel Tank")]
    public class FuelTankTests
    {
        ...
        Generator.Components.FuelTank.FuelTank fuelTank;
        ...
        public void Setup()
        {
            ...
            fuelTank = new Generator.Components.FuelTank.FuelTank(mockContext.Object, configurationService.Object, errorService.Object, conversionService, currencyService, monitorService.Object);
        }
        ...
        public void Test_GetClaims_Returns_AP()
        {
            ...
            var result = fuelTank.Fill("BPS", 100, false);
        ...
        public void Test_GetClaims_Returns_AP_XB()
        {
            ...
            var result = fuelTank.Fill("XB", 100, false);
        ...
        public void Test_GetClaim_Returns_Claim()
        {
            ...
            var result = fuelTank.GetClaim("S1234567C123456V001", 1234567890, 2016);
        ...
        public void Test_GetXBData_Returns_XBData()
        {
            ...
            var result = fuelTank.GetXBData("S1234567C123456V001", 1234567890, 2016, new DateTime(2016, 1, 1), false);
        ...
        public void Test_GetXBData_Returns_Latest_Calculation_Before_Settlement()
        {
            ...
            var result = fuelTank.GetXBData("S1234567C123456V001", 1234567890, 2016, new DateTime(2016, 1, 2), false);
        ...
        public void Test_GetInvoices_Gets_AP()
        {
            ...
            var result = fuelTank.GetInvoices(1234567890, 2016, 1, "BPS", false);
        ...
        public void Test_GetClaimValue_Returns_Value()
        {
            ...
            var result = fuelTank.GetClaimValue("S1234567C123456V001", 1234567890, 2016, new DateTime(2016, 1, 1), "BPS", false);
        ...
        public void Test_GetClaimValue_Returns_Value_XB()
        {
            ...
            var result = fuelTank.GetClaimValue("S1234567C123456V001", 1234567890, 2016, new DateTime(2016, 1, 1), "XB", false);
        ...
        public void Test_GetAR_Returns_AR()
        {
            ...
            var result = fuelTank.GetAR(1234567890, 2016);
        ...
        public void Test_BuildSkips_Includes_Errors()
        {
            ...
            var result = fuelTank.BuildSkips(errors, new List<Suppression>(), new List<XB>(), "BPS");
        ...
        {            
            ...
            var result = fuelTank.BuildSkips(new List<Error>(), suppressions, new List<XB>(), "BPS");
        ...
        public void Test_BuildSkips_Includes_XB_For_BPS()
        {
            ...
            var result = fuelTank.BuildSkips(new List<Error>(), new List<Suppression>(), xbList, "BPS");
        ...
        public void Test_BuildSkips_Does_Not_Include_XB_For_XB()
        {
            ...
            var result = fuelTank.BuildSkips(new List<Error>(), new List<Suppression>(), xbList, "XB");
        ...
        public void Test_RefineMaximumBatchSize_Returns_Original_If_Valid()
        {
            ...
            var fuelTank = new Generator.Components.FuelTank.FuelTank(mockContext.Object, configurationService.Object, errorService.Object, conversionService, currencyService, monitorService.Object);

            var result = fuelTank.RefineMaximumBatchSize(50, 100);
        ...
        public void Test_RefineMaximumBatchSize_Returns_TotalDAX_If_TotalDAX_Is_Lower()
        {
            ...
            var result = fuelTank.RefineMaximumBatchSize(50, 20);
        ...
        public void Test_OrderDAX_Does_Not_Order_If_Total_Less_Than_Maximum()
        {
            ...
            var result = fuelTank.OrderDAX(daxOutstanding, 10);
        ...
        public void Test_OrderDAX_Does_Not_Order_If_Total_Equals_Maximum()
        {
            ...
            var result = fuelTank.OrderDAX(daxOutstanding, 2);
        ...
        public void Test_OrderDAX_Orders_If_Total_Greater_Than_Maximum()
        {
            ...
            var result = fuelTank.OrderDAX(daxOutstanding, 1);
        ...
        public void Test_OrderDAX_Does_Not_Error_If_Only_One_DAX()
        {
            ...
            Assert.DoesNotThrow(() => fuelTank.OrderDAX(daxOutstanding, 0));
        }
        ...
        public void Test_OrderDAX_Does_Not_Error_If_No_DAX_With_Maximum()
        {
            ...
            Assert.DoesNotThrow(() => fuelTank.OrderDAX(daxOutstanding, 1));
        }
    }
}
