...
{
    public class ARImportService : IDisposable, IARImportService
    {
        ...
        public ARImportService(IClaimStatementsContext context, IConfigurationService configurationService, IFolderService folderService, IErrorService errorService, IFileService fileService, IMonitorService monitorService)
        {
            this.db = context;
            ...
            if(configurationService.IsActive("AR Load"))
            {
                ...
                try
                {
                    ...
                    foreach (string file in files)
                    {
                        ...
                        Models.Entities.CS.Monitor monitor = new Models.Entities.CS.Monitor(monitorService.GetMonitorProcessId("Import DAX AR"), string.Format(info.Name));
