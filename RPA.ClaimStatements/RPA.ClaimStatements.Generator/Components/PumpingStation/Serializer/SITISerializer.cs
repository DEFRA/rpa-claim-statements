                        ...
                        switch (currentLine)
                        {
                            ...
                            case "PTBPEN":
                                ...
                                if (lastLine == "PTBE")
                                {
                                    claim.BPSPEN = new BPSPEN
                                    {
                                        ...
                                        LateChangePenaltyReduction = !string.IsNullOrEmpty(csv.GetField<string>(11)) ? csv.GetField<decimal>(11) : 0,
                                        FDMPercent = !string.IsNullOrEmpty(csv.GetField<string>(12)) ? csv.GetField<decimal>(12) : 0,
                                        FDMReduction = !string.IsNullOrEmpty(csv.GetField<string>(13)) ? csv.GetField<decimal>(13) : 0,
                                        ReductionOfPaymentsOver150kPercent = !string.IsNullOrEmpty(csv.GetField<string>(14)) ? csv.GetField<decimal>(14) : 0,
                                        ReductionOfPaymentsOver150kReduction = !string.IsNullOrEmpty(csv.GetField<string>(15)) ? csv.GetField<decimal>(15) : 0,
                                        TotalBPS = !string.IsNullOrEmpty(csv.GetField<string>(16)) ? csv.GetField<decimal>(16) : 0,
                                        OverDeclarationPercent = !string.IsNullOrEmpty(csv.GetField<string>(17)) ? csv.GetField<decimal>(17) : 0,
                                        NonDeclarationPercent = !string.IsNullOrEmpty(csv.GetField<string>(18)) ? csv.GetField<decimal>(18) : 0,
                                        NonDeclarationReduction = !string.IsNullOrEmpty(csv.GetField<string>(19)) ? csv.GetField<decimal>(19) : 0,
                                        AdditionalOverDeclarationReduction = !string.IsNullOrEmpty(csv.GetField<string>(20)) ? csv.GetField<decimal>(20) : 0,
                                        PreviousYearOverDeclaration = !string.IsNullOrEmpty(csv.GetField<string>(21)) ? csv.GetField<bool>(21) : false
                                    };
                            ...
                            case "PTBGPEN":
                                ...
                                if (lastLine == "PTBG")
                                {
                                    claim.GRPEN = new GRPEN
                                    {
                                        ...
                                        LateChangePenaltyReduction = !string.IsNullOrEmpty(csv.GetField<string>(14)) ? csv.GetField<decimal>(14) : 0,
                                        FDMReduction = !string.IsNullOrEmpty(csv.GetField<string>(15)) ? csv.GetField<decimal>(15) : 0,
                                        TotalGreening = !string.IsNullOrEmpty(csv.GetField<string>(16)) ? csv.GetField<decimal>(16) : 0,
                                        ...
                                        AdministrativeArea = !string.IsNullOrEmpty(csv.GetField<string>(19)) ? csv.GetField<decimal>(19) : 0,
                                        AdministrativeReduction = !string.IsNullOrEmpty(csv.GetField<string>(20)) ? csv.GetField<decimal>(20) : 0,
                                        CropDiversificationNumberAdditional = !string.IsNullOrEmpty(csv.GetField(21)) ? csv.GetField<decimal>(21) : 0,
                                        EFANumberAdditional = !string.IsNullOrEmpty(csv.GetField(22)) ? csv.GetField<decimal>(22) : 0
                                    };
                            ...
                            case "PTBYF":
                                ...
                                if (lastLine == "PTBGPEN")
                                {
                                    claim.YF = new YF
                                    {
                                        ...
                                        LateEvidencePercent = !string.IsNullOrEmpty(csv.GetField<string>(7)) ? csv.GetField<decimal>(7) : 0,
                                        LateEvidenceReduction = !string.IsNullOrEmpty(csv.GetField<string>(8)) ? csv.GetField<decimal>(8) : 0,
                                        LateChangePenaltyReduction = !string.IsNullOrEmpty(csv.GetField<string>(9)) ? csv.GetField<decimal>(9) : 0,
                                        FDMReduction = !string.IsNullOrEmpty(csv.GetField<string>(10)) ? csv.GetField<decimal>(10) : 0,
                                        TotalYF = !string.IsNullOrEmpty(csv.GetField<string>(11)) ? csv.GetField<decimal>(11) : 0,
                                        OverDeclarationPercent = !string.IsNullOrEmpty(csv.GetField<string>(12)) ? csv.GetField<decimal>(12) : 0,
                                        NonSDANumber = !string.IsNullOrEmpty(csv.GetField<string>(13)) ? csv.GetField<decimal>(13) : 0,
                                        SDANumber = !string.IsNullOrEmpty(csv.GetField<string>(14)) ? csv.GetField<decimal>(14) : 0,
                                        MoorlandNumber = !string.IsNullOrEmpty(csv.GetField<string>(15)) ? csv.GetField<decimal>(15) : 0,
                                        TotalEntitlementValue = !string.IsNullOrEmpty(csv.GetField<string>(16)) ? csv.GetField<decimal>(16) : 0,
                                        NonDeclarationPercent = !string.IsNullOrEmpty(csv.GetField<string>(17)) ? csv.GetField<decimal>(17) : 0,
                                        NonDeclarationReduction = !string.IsNullOrEmpty(csv.GetField<string>(18)) ? csv.GetField<decimal>(18) : 0,
                            ...
                            case "PTBPR":
                                ...
                                if (lastLine == "PTBYF")
                                {
                                    ...
                                    {
                                        ClaimID = claim.ClaimID,
                                        PRB1MaxBand = !string.IsNullOrEmpty(csv.GetField<string>(1)) ? csv.GetField<decimal>(1) : 0,
                                        PRB1Percent = !string.IsNullOrEmpty(csv.GetField<string>(2)) ? csv.GetField<decimal>(2) : 0,
                                        PRB1Result = !string.IsNullOrEmpty(csv.GetField<string>(3)) ? csv.GetField<decimal>(3) : 0,
                                        PRB2MaxBand = !string.IsNullOrEmpty(csv.GetField<string>(4)) ? csv.GetField<decimal>(4) : 0,
                                        PRB2Percent = !string.IsNullOrEmpty(csv.GetField<string>(5)) ? csv.GetField<decimal>(5) : 0,
                                        PRB2Result = !string.IsNullOrEmpty(csv.GetField<string>(6)) ? csv.GetField<decimal>(6) : 0,
                                        PRB3MaxBand = !string.IsNullOrEmpty(csv.GetField<string>(7)) ? csv.GetField<decimal>(7) : 0,
                                        PRB3Percent = !string.IsNullOrEmpty(csv.GetField<string>(8)) ? csv.GetField<decimal>(8) : 0,
                                        PRB3Result = !string.IsNullOrEmpty(csv.GetField<string>(9)) ? csv.GetField<decimal>(9) : 0,
                                        PRB4MaxBand = !string.IsNullOrEmpty(csv.GetField<string>(10)) ? csv.GetField<decimal>(10) : 0,
                                        PRB4Percent = !string.IsNullOrEmpty(csv.GetField<string>(11)) ? csv.GetField<decimal>(11) : 0,
                                        PRB4Result = !string.IsNullOrEmpty(csv.GetField<string>(12)) ? csv.GetField<decimal>(12) : 0,
                                        PRBTotalResult = !string.IsNullOrEmpty(csv.GetField<string>(13)) ? csv.GetField<decimal>(13) : 0
                                    };
